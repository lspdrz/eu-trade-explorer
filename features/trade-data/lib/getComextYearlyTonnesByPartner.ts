 ...
 * EU-wide yearly totals per partner country. An unknown product (one without
 * a heading) yields [] and never touches the DB; the RSC's product fallback
 * means that shouldn't happen in practice.
 */
